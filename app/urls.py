...
urlpatterns = [
    ...
    path('password-reset/done/', auth_view.PasswordResetView.as_view(template_name='app/password_reset_done.html'),
...
admin.site.site_header = "Zaika Baker's"
admin.site.site_title = "Zaika Baker's"
admin.site.site_index_title = "Welcome to Zaika Baker's E-shop"
